<div class="page page-icons">
	...
	<ol class="breadcrumb breadcrumb-small">
		<li>UI Elements</li>
		<li class="active"><a href="#/ui/icons">Icons</a></li>
	</ol>


	<div class="page-wrap">
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">40 New Icons in 4.2<hr/></h4>
			<div class="row fontawesome-icon-list">
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-angellist"></i> fa-angellist</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-area-chart"></i> fa-area-chart</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-at"></i> fa-at</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bell-slash"></i> fa-bell-slash</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bell-slash-o"></i> fa-bell-slash-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bicycle"></i> fa-bicycle</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-binoculars"></i> fa-binoculars</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-birthday-cake"></i> fa-birthday-cake</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bus"></i> fa-bus</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-calculator"></i> fa-calculator</div>

				<div class="fa-hover col-md-3 col-sm-4"<i class="fa fa-cc"></i> fa-cc</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cc-amex"></i> fa-cc-amex</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cc-discover"></i> fa-cc-discover</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cc-mastercard"></i> fa-cc-mastercard</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cc-paypal"></i> fa-cc-paypal</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cc-stripe"></i> fa-cc-stripe</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cc-visa"></i> fa-cc-visa</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-copyright"></i> fa-copyright</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eyedropper"></i> fa-eyedropper</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-futbol-o"></i> fa-futbol-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-google-wallet"></i> fa-google-wallet</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ils"></i> fa-ils</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ioxhost"></i> fa-ioxhost</div>
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Web Application Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-automobile"></i> fa-automobile <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ban"></i> fa-ban</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bank"></i> fa-bank <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart"></i> fa-bar-chart</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart-o"></i> fa-bar-chart-o <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bomb"></i> fa-bomb</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-building"></i> fa-building</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cab"></i> fa-cab <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-car"></i> fa-car</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-child"></i> fa-child</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle-o-notch"></i> fa-circle-o-notch</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle-thin"></i> fa-circle-thin</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-clock-o"></i> fa-clock-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-close"></i> fa-close <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cube"></i> fa-cube</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cubes"></i> fa-cubes</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-database"></i> fa-database</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-envelope-square"></i> fa-envelope-square</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fax"></i> fa-fax</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-archive-o"></i> fa-file-archive-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-audio-o"></i> fa-file-audio-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-code-o"></i> fa-file-code-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-excel-o"></i> fa-file-excel-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-image-o"></i> fa-file-image-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-movie-o"></i> fa-file-movie-o <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-pdf-o"></i> fa-file-pdf-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-photo-o"></i> fa-file-photo-o <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-picture-o"></i> fa-file-picture-o <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-powerpoint-o"></i> fa-file-powerpoint-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-sound-o"></i> fa-file-sound-o <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-video-o"></i> fa-file-video-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-word-o"></i> fa-file-word-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-zip-o"></i> fa-file-zip-o <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-graduation-cap"></i> fa-graduation-cap</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-history"></i> fa-history</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-home"></i> fa-home</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-image"></i> fa-image <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-institution"></i> fa-institution <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-language"></i> fa-language</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-bouy"></i> fa-life-bouy <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-buoy"></i> fa-life-buoy <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-ring"></i> fa-life-ring</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-saver"></i> fa-life-saver <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-reply-all"></i> fa-mail-reply-all <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mortar-board"></i> fa-mortar-board <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-music"></i> fa-music</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-navicon"></i> fa-navicon <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-newspaper-o"></i> fa-newspaper-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paint-brush"></i> fa-paint-brush</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paper-plane"></i> fa-paper-plane</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paper-plane-o"></i> fa-paper-plane-o</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paw"></i> fa-paw</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-photo"></i> fa-photo <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-recycle"></i> fa-recycle</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-refresh"></i> fa-refresh</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-remove"></i> fa-remove <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reorder"></i> fa-reorder <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-send"></i> fa-send <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-send-o"></i> fa-send-o <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-share"></i> fa-share</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-share-alt"></i> fa-share-alt</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-share-alt-square"></i> fa-share-alt-square</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sliders"></i> fa-sliders</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-space-shuttle"></i> fa-space-shuttle</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-spinner"></i> fa-spinner</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-spoon"></i> fa-spoon</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-support"></i> fa-support <span class="text-muted">(alias)</span></div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-taxi"></i> fa-taxi</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-tree"></i> fa-tree</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-university"></i> fa-university</div>
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">File Type Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Spinner Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle-o-notch"></i> fa-circle-o-notch</div>
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Form Control Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square"></i> fa-check-square</div>
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Payment Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Chart Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-area-chart"></i> fa-area-chart</div>
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Currency Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Text Editor Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-header"></i> fa-header</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paragraph"></i> fa-paragraph</div>
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Directional Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Video Player Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
		...
		<div class="alert alert-success">
			<ul class="margin-bottom-none mb15">
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Brand Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-behance"></i> fa-behance</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-behance-square"></i> fa-behance-square</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-codepen"></i> fa-codepen</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-css3"></i> fa-css3</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-delicious"></i> fa-delicious</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-deviantart"></i> fa-deviantart</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-digg"></i> fa-digg</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-drupal"></i> fa-drupal</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-empire"></i> fa-empire</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ge"></i> fa-ge <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-git"></i> fa-git</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-git-square"></i> fa-git-square</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-google"></i> fa-google</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hacker-news"></i> fa-hacker-news</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-joomla"></i> fa-joomla</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-jsfiddle"></i> fa-jsfiddle</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-openid"></i> fa-openid</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pagelines"></i> fa-pagelines</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paypal"></i> fa-paypal</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pied-piper"></i> fa-pied-piper</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pied-piper-alt"></i> fa-pied-piper-alt</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-qq"></i> fa-qq</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ra"></i> fa-ra <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rebel"></i> fa-rebel</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reddit"></i> fa-reddit</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reddit-square"></i> fa-reddit-square</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-slack"></i> fa-slack</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-slideshare"></i> fa-slideshare</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-soundcloud"></i> fa-soundcloud</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-spotify"></i> fa-spotify</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-steam"></i> fa-steam</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-steam-square"></i> fa-steam-square</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stumbleupon"></i> fa-stumbleupon</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stumbleupon-circle"></i> fa-stumbleupon-circle</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-tencent-weibo"></i> fa-tencent-weibo</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-vine"></i> fa-vine</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-vk"></i> fa-vk</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-wechat"></i> fa-wechat <span class="text-muted">(alias)</span></div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-weibo"></i> fa-weibo</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-weixin"></i> fa-weixin</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-windows"></i> fa-windows</div>

				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-wordpress"></i> fa-wordpress</div>
				...
				<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yahoo"></i> fa-yahoo</div>
		...
		<div class="row">
			<h4 class="h5 mb20 ml15 mr15">Medical Icons<hr/></h4>
			<div class="row fontawesome-icon-list">
